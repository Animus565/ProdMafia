...
public class StatusBar extends Sprite
{
    ...
    public var scramble:Boolean = false;
    ...
    public function draw(param1:int, param2:int, param3:int, param4:int = -1, param5:int = 0, param6:int = 0, param7:Boolean = false) : void
    {
        if(param2 > 0)
        {
    ...
    public function drawWithMouseOver() : void
    {
        ...
        if(Parameters.data.toggleToMaxText)
        {
            ...
            {
                _loc3_ = _loc3_ + ("|" + Math.ceil(_loc2_ * 0.2));
            }
        }
        if(this.max_ > 0)
        {
            this.valueText_.setStringBuilder(this.valueTextStringBuilder_.setString((!!this.scramble?int(Math.random() * 100000):int(this.val_)) + "/" + this.max_ + _loc3_));
        }
        else
        {
            this.valueText_.setStringBuilder(this.valueTextStringBuilder_.setString("" + (!!this.scramble?int(Math.random() * 100000):int(this.val_))));
        }
        ...
        if(this.boost_ - this.exalted != 0 || this.exalted != 0)
        {
            ...
            {
                _loc1_ = _loc1_ + (" (" + (this.boost_ - this.exalted > 0?"+":"") + (this.boost_ - this.exalted).toString() + ")");
            }
            this.boostText_.setStringBuilder(this.valueTextStringBuilder_.setString(_loc1_));
