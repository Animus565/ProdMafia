...
public class Options extends Sprite {
    ...
    public function addVisualOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("dataScrambler",makeOnOffLabels(),[true,false],"Data Scrambler","This toggles whether to randomize identifiable data on your screen",null));
        this.addOptionAndPosition(new ChoiceOption("sepProjUpdate",makeOnOffLabels(),[true,false],"Separate Projectile Updating","This toggles whether to update projectiles on a timer separate from FPS",onProjUpdateChange));
    }
    ...
    public function addOtherOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("antiSpeedy",makeOnOffLabels(),[true,false],"Disable Speedy","This toggles whether to disable the extra speed from the Speedy condition",null));
    ...
    public function addEpicOptions() : void {
        ...
        this.addOptionAndPosition(new KeyMapper("depositKey", "Deposit Key", "The key which deposits all of your items into your vault"));
    ...
    {
        this.gs_.refreshProjUpdateTimerStatus();
    }
